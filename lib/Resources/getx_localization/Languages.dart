...
class Languages extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        ...
        'ur_PK': {
          ...
          'hint1': "اپنا ای میل درج کریں۔",
          'hint2': "اپنا پاس ورڈ درج کریں",
          'Internet_Exception':
              "We are  اس ورڈ درج کریto connect to the server\n Check your internet connection"
        },
        'ja_JP': {
        ...
        'hi_IN': {
          ...
          'hint1': "अपना ईमेल दर्ज करें",
          'hint2': "अपना कूटशब्द भरें",
          // 'Internet_Exception':
          //     "We are unable to connect to the server\n Check your internet connection"
        }
      };
